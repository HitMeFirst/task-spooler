...
int main() {
    ...
    sprintf(manPage, ".\\\" Copyright @ Duc Nguyen & Lluís Batlle i Rossell\n"
                     ...
                     "Without -O, the stdout file gets created with mkstemp, ensuring it does not overwrite\n"
                     "any other; the \".e\" will be overwritten if it existed.\n"
                     ".TP\n"
                     ".B \"\\-O [name]\"\n"
                     "Set the log name to the specified name with a .txt suffix. If the name includes a path, parent directories are created as needed; otherwise it is created under the log directory. Existing files are overwritten.\n"
                     ".TP\n"
                     ".B \"\\-N [num]\"\n"
                     ...
                     ".TP\n"
                     ".B --short_output\n"
                     "Show shortened output filenames in the job list. By default, the complete filename is shown.\n"
                     ".TP\n"
